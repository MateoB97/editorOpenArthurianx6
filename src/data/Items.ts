...
const Items = [
  {
    ...
    appearance: "fish",
    description:
      "Common and small, but tastes great friend, raw, or in a stew. A chef's best friend.",
    name: "Fish",
  },
  {
    id: "lobster",
  ...
  },
  {
    ...
    name: "Mystic Sword",
    description:
      "The greatest works of Zircon of Minoc, we found them in Serpent's Hold, during the Quest of the Avatar. They were vital to finish off the foes in the Abyss.",
    damage: 20,
  },
  {
    id: "spear",
  ...
  },
  {
    ...
    effect: {
      ...
      fragments: [0, 2400, 4807, 7210, 9613, 12009, 14414, 16812, 18872],
    },
    useOnSelf: true,
  },
  {
